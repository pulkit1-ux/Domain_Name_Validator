...
if (filter_var($sourceEmailId, FILTER_VALIDATE_EMAIL)) {
...
echo"<font color=\"antiquewhite\"><h2><center>THE EMAIL FORMAT ENTERED IS INVALID</font></center></h2>";
}
...
<!DOCTYPE html>
<html>
<head><script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/2.0.2/anime.min.js"></script>
  <title></title>
  <style>
    .ml11 {
  font-weight: 700;
